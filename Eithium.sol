...
contract ElitheumDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor(string memory _name,string memory _symbol,uint8 _decimals) public DividendPayingToken(_name, _symbol, _decimals) {
    	claimWait = 3600;
...
contract Elitheum is BEP20, Ownable {
    ...
    constructor(string memory _name, string memory _symbol) public BEP20(_name, _symbol, 18) {
        uint256 _CICRewardsFee = 4;
        uint256 _liquidityFee = 1;
        uint256 _marketingFee = 1; 
        address burnAdd = 0x000000000000000000000000000000000000dEaD;
        CICRewardsFee = _CICRewardsFee;
        liquidityFee = _liquidityFee;
        marketingFee = _marketingFee;
        totalFees = _CICRewardsFee.add(_liquidityFee).add(_marketingFee);
        ...
        //testnet
     IPancakeswapV2Router02 _pancakeswapV2Router = IPancakeswapV2Router02(0xf914eb7D9069d26720E74381a617E066D43Ca314);
